...
export const VplayPrimaryButton: React.FC<VplayPrimaryButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`
        relative select-none font-montserrat text-sm sm:text-base font-bold overflow-hidden !p-0 inline-flex flex-col
    ...
    >
      ...
      <div className={`relative w-full h-full flex flex-col ${layer3Bg}`}>
        ...
        <div
          className={`
            relative z-10 w-full flex items-center justify-center gap-2 px-5 py-2
